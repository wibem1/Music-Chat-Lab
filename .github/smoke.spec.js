...
test('core ui', async ({ page }) => {
  ...
  await expect(page.locator('[data-app-version]')).toHaveText('v1.6.2');
  ...
  await expect(page.locator('#infoDialog')).toContainText('Composition Engine v1.0.0');
  ...
  expect(sharedEngine.version).toBe('1.0.0');
