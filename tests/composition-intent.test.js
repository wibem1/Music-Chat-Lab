...
assert(i.freshCompose({text:'Erstelle ein Klavierstück.',message:{files:[]}}));
assert(i.freshCompose({text:'Komponiere ein Stück für Cello und Klavier.',message:{files:[]}}));
assert(!i.freshCompose({text:'Mache eine Variation von Speicher 1.',message:{files:[]}}));
assert(!i.freshCompose({text:'Ergänze Speicher 1 um eine Violinstimme.',message:{files:[]}}));
assert(!i.freshCompose({text:'Komponiere ein neues Stück aus dieser Datei.',message:{files:[{kind:'midi'}]}}));
