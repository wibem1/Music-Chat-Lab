(()=>{
'use strict';
if(window.__mclCompositionIdeaFieldV1317)return;
window.__mclCompositionIdeaFieldV1317=true;
...
function activeDescription(){const item=activeItem();return String(item?.score?.sm||'').trim()}
...
window.MCLCompositionIdea={version:'1.3.17',get,set,syncFromActive,restoreDraft,compactGenerated,activeChatId,syncDescription};
