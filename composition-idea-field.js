(()=>{
'use strict';
if(window.__mclCompositionIdeaFieldV1313)return;
window.__mclCompositionIdeaFieldV1313=true;
...
window.MCLCompositionIdea={version:'1.3.13',get,set,syncFromActive,restoreDraft,compactGenerated,activeChatId};
