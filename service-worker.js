const CACHE_NAME = 'music-chat-lab-v1.6.2';
const APP_SHELL = [
  ...
  './composition-engine14.js', './composition-engine.js', './composition-state.js', './session-orchestrator.js',
...
'./midi-slot-delete.js', './player-variants.js',
