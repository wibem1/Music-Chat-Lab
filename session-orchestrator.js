...
function sharedEngine(){const engine=window.CompositionEngine;if(!engine?.compose||engine.version!=='1.3.0')throw new Error('Composition Engine 1.3 ist nicht geladen.');return engine}
