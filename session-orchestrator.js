...
function sharedEngine(){const engine=window.CompositionEngine;if(!engine?.compose||!engine.version)throw new Error('Composition Engine 1.3 ist nicht geladen.');return engine}
